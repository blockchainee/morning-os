...
2. The app auto-loads the latest `briefing.json` generated by GitHub Actions
3. Notion receives a rich-formatted copy of each daily briefing automatically
4. Use ⚙️ Settings to configure newsletter sources and podcast preferences
